...
// export default function CouponInput({ subtotal = 0, roomId, onApply }) {
...
//           onClick={applyCoupon}
//           disabled={loading}
//           className={`px-4 py-2 rounded font-medium ${loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-gray-800 text-white cursor-pointer hover:bg-gray-900'}`}
//         >
//           {loading ? 'Applying...' : 'Apply'}
//         </button>
//       </div>
//       {message && (
//         <div className={`mt-2 text-sm ${message.type === 'error' ? 'text-red-600' : 'text-green-700'}`}>
//           {message.text}
//         </div>
//       )}
//     </div>
