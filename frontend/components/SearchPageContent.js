...
//                     src={room.images[0]}
//                     alt={room.title}
//                     className="w-full md:w-1/3 h-[220px] md:h-[268px] object-cover"
//                   />
//                 ) : (
//                   <div className="w-full md:w-1/3 h-[220px] md:h-[268px] bg-gray-200 flex items-center justify-center text-gray-500">
//                     No Image
//                   </div>
//                 )}
