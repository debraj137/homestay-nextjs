  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full md:w-auto">
        ...
        <button
          type="submit"
          className="cursor-pointer px-4 py-2 text-white font-medium bg-gray-700 hover:bg-gray-800 flex items-center space-x-2 w-full md:w-auto justify-center text-sm md:text-base rounded"
        >
