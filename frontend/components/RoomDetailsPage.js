...
export default function RoomDetailsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      {/* 🖼️ Thumbnails */}
      <div className="flex gap-2 mb-6 overflow-x-auto sm:overflow-visible">
        {room.images?.map((img, idx) => (
          <img
            ...
            className={`w-24 h-24 flex-shrink-0 object-cover rounded-lg border cursor-pointer transition 
