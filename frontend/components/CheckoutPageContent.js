...
export default function CheckoutPageContent() {
  ...
  if (!user) return <p className="text-center mt-10 text-red-600">Please login to continue booking.</p>;
    ...
    <div className="max-w-4xl mx-auto px-6 py-10 bg-white rounded-lg shadow">
      ...
      <button
        ...
        className={`w-full px-6 py-3 rounded-lg font-semibold text-white ${
          bookingLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-500 hover:bg-red-600'
        }`}
      >
