  ...
  useEffect(() => {
    async function fetchRoom() {
      try {
        ...
        // ✅ Ensure discount exists even if not returned
        setFormData({
          discount: 0,
          ...data,
          location: {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <input
              ...
              placeholder="Locality (e.g. Ramkot)"
              ...
              {formData.location.nearestLocalities?.map((loc, i) => (
                <div key={i} className="flex items-center space-x-2 mb-2">
                  <input
                    ...
                    onChange={(e) => {
                      const updated = [...formData.location.nearestLocalities];
                      updated[i] = e.target.value;
                      setFormData(prev => ({
                        ...prev,
                        location: {
                          ...prev.location,
                          nearestLocalities: updated,
                        },
                      }));
                    }}
                    className="w-full px-4 py-2 border rounded-lg"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block font-medium mb-2">Maximum Allowed Adults</label>
            <input
              type="number"
          ...
          <div>
            <label className="block font-medium mb-2">Maximum Allowed Children</label>
            <input
              type="number"
